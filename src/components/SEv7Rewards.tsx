...
const SEv7Rewards: React.FC = () => {
  ...
  const contractAddress = "0x124026f834b208595b54a19a94cf10f55568bb55"; // Dirección del contrato
  ...
  const rewardRate = 5000; // Recompensa fija por USDC
