...
const WGsaTokenBalanceThree = () => {
  ...
  const contractAddress = '0xDA99b83Effd726f25f6bbB49fBf70844D1B85DbD'; // Dirección del contrato donde queremos verificar el balance
...
export default WGsaTokenBalanceThree;
