...
const TOKEN_MIGRATION_CONTRACT_ADDRESS = "0x86cdb490248ae43b19dbf0c6aa44a8788d23cfee"; // Dirección del nuevo contrato
...
const TokenSwap = () => {
    ...
    return (
        <section id="news">
            <div id="token-migration" className="container">
                <h3 className="fn__maintitle big" data-text="Token Migration" data-align="center">
                    Token Migration
                </h3>
                {/* News Shotcode */}
                                    ...
                                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: "5px" }}>
                                        <div>
                                            <p style={{ fontSize: "12px", margin: 0 }}>
                                                <img src={isOldToNew ? "/img/LOGOS-GS-32x32.png" : "/img/GSAV2.png"} style={{ width: "20px" }} /> Balance: {isOldToNew ? oldTokenBalance : newTokenBalance}
                                            </p>
                                        </div>
                                        <a
                                            style={{
