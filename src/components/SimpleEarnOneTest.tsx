...
const SEHeader: React.FC = () => {
    ...
    const updateQuantity = (operation: string) => {
        if (operation === "+" && amountToStake < 100000000) {
            setAmountToStake(amountToStake + 100000);
    ...
    return (
        <section id="news">
            <div id="simple-earn-v2" className="container">
                <h3 className="fn__maintitle big" data-text="Simple Earn V2" data-align="center">
                    Simple Earn V2
                </h3>
                    ...
                    <div className="news_part">
                        <div className="left_items">
                            <div className="blog__item">
                                ...
                                <div className="title">
                                    <p style={{ color: "yellow" }}>Token Migration is progress unstake your tokens.</p>
                                </div>
