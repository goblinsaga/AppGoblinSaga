...
const WGsaTokenBalanceFour = () => {
  ...
  const contractAddress = '0x5A0b55E1dbD455d3973fA3A2B807AB156b91a9B7'; // Dirección del contrato donde queremos verificar el balance
...
export default WGsaTokenBalanceFour;
