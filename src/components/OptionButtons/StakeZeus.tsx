...
import { STAKING_CONTRACT_ADDRESS, BUSINESSES_CONTRACT_ADDRESS } from "../../../consts/ZeusContracts";
...
import NFTContractABI from "../../../contracts/BusinessesContractABI.json";

const StakeZeusNFT: React.FC = () => {
    ...
    const { contract: nftContract } = useContract(BUSINESSES_CONTRACT_ADDRESS, NFTContractABI);
    ...
    async function approveAndStake() {
        ...
        try {
            ...
            const nftContractInstance = new ethers.Contract(BUSINESSES_CONTRACT_ADDRESS, NFTContractABI, signer);
            ...
            // Revisar qué NFTs tiene en cartera (IDs 0 al 14)
            ...
            setSuccessMessage("Thanks for help Zeus!");
        } catch (error) {
    ...
    return (
        <div>
            ...
            >
                {isStaking ? "Mining..." : "Mine Zeus"}
            </button>
        </div>
    );
};

export default StakeZeusNFT;
