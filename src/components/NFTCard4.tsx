...
export default function NFTCard4({ nft }: Props) {
    // Solo mostrar NFTs con IDs 12, 13 y 14
    const includedIds = [12, 13, 14];
    if (!includedIds.includes(Number(nft.metadata.id))) {
        return null; // No renderizar el componente si el ID no está en la lista de incluidos
    }
