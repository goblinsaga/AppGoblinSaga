...
// Configuración
const contractAddress = '0x66984736ed5a91c598af721f55a496ecef81d94f';
...
const GSAdr3 = () => {
    ...
    const handleTweet = () => {
        const tweetText = encodeURIComponent(
            "@EPopGirlsNFT the next level of erotic #NFTs MINT NOW! #Blockchain #Crypto $POL https://x.com/EPopGirlsNFT/status/1910319455923486875"
        );
