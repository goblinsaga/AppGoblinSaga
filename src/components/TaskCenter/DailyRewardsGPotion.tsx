...
import { BUSINESSES_CONTRACT_ADDRESS2, STAKING_CONTRACT_ADDRESS } from "../../../consts/contracts2New";
...
const contractAddress = '0x80d89a39fa93d03720aac5a1e49956cca9014008';

const ClaimRewardsNFTClaimTwo = () => {
    ...
    const handleStake = async () => {
        try {
            ...
            await stakingContract?.call("stake", [6, quantity]); // Usa el ID del NFT 6 y la cantidad seleccionada
                            ...
                            <div style={{ position: "relative", width: "150px", height: "45px", marginRight: "-10px" }}>
                                <Web3Button
                                    ...
                                    action={async (contract) => {
                                        ...
                                        await contract.erc1155.claim(6, 1);
                                    ...
                                    onError={(error) => {
                                        ...
                                        if (
                                            ...
                                            setErrorMessage(`Minting failed: Insufficient funds. Mint price 3.0 POL.`);
                                        } else {
...
export default ClaimRewardsNFTClaimTwo;
