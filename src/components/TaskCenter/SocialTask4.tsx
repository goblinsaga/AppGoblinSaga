...
// Configuración
const contractAddress = '0x0450fcd663787eb99ee1d223f316382ffc1cd484';
...
const GSAdr4 = () => {
    ...
    const handleTweet = () => {
        const tweetText = encodeURIComponent(
            "Cant wait to stake, earn $EPOP and claim my Epop Girl. LFG! #NFT #Crypto #Polygon $POL https://x.com/EPopGirlsNFT/status/1907866694703272149"
        );
