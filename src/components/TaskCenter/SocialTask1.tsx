...
// Configuración
const contractAddress = '0xe4c4ea9e42fea530af83f9d4771cd65a70d03eb3';
...
const GSAdr1 = () => {
    ...
    const handleTweet = () => {
        const tweetText = encodeURIComponent(
            "Forge your legacy in the realm of DeFi with mighty Goblin NFTs. Claim daily rewards, conquer the mines, and etch your name into blockchain history. #NFT $POL #Crypto https://x.com/goblinsaga_xyz/status/1910869241995141417"
        );
