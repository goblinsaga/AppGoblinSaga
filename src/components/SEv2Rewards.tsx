...
const SEv2Rewards: React.FC = () => {
    ...
    const contractAddress = "0xfa4aC4ADFB3D98646B16ec7a2d4d7c3082ab31D9"; // Dirección del contrato
    ...
    const rewardRate = 1000; // Recompensa fija por MATIC
