...
const WGsaTokenBalanceFive = () => {
  ...
  const contractAddress = '0x124026f834b208595b54a19a94cf10f55568bb55'; // Dirección del contrato donde queremos verificar el balance
...
export default WGsaTokenBalanceFive;
