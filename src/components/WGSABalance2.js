...
const WGsaTokenBalance = () => {
  ...
  const contractAddress = '0x0134068820CEe34aa11806158C7f7386Da29b4F1'; // Dirección del contrato donde queremos verificar el balance
...
export default WGsaTokenBalance;
