...
const EmperorCheck = ({ onVerificationStatus }) => {
        ...
        <div style={{
            ...
            {loading ? (
                ...
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
                    <img
                        src="/img/EMPEROR-RANK.png"
                        alt="Emperor Rank"
                        style={{ width: "65px", height: "auto", cursor: "pointer" }}
                    />
                    <p style={{ fontSize: "12px", margin: "5px 0 0 0" }}>Emperor</p>
                </div>
            ) : (
                <div>
                    <p style={{
                        ...
                        You need 15 Goblins to own this badge.
                    </p>
                </div>
            )}
        </div>
