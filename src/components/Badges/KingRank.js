...
const KingCheck = ({ onVerificationStatus }) => {
        ...
        >
            {loading ? (
                ...
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
                    <img
                        src="/img/KING-RANK.png"
                        alt="King Rank"
                        style={{ width: "65px", height: "auto", cursor: "pointer" }}
                    />
                    <p style={{ fontSize: "12px", margin: "5px 0 0 0" }}>King</p>
                </div>
            ) : (
                <div>
                    <p style={{
                        ...
                        You need 10 Goblins to own this badge.
                    </p>
                </div>
            )}
        </div>
