...
const LordCheck = ({ onVerificationStatus }) => {
        ...
        >
            {loading ? (
                ...
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
                    <img
                        src="/img/LORD-RANK.png"
                        alt="King Rank"
                        style={{ width: "65px", height: "auto", cursor: "pointer" }}
                    />
                    <p style={{ fontSize: "12px", margin: "5px 0 0 0" }}>Lord</p>
                </div>
            ) : (
                <div>
                    <p style={{
                        ...
                        You need 8 Goblins to own this badge.
                    </p>
                </div>
            )}
        </div>
